    ...
    protected void paintComponent(Graphics g) {
        ...
        for (int i = 0; i < numberYDivisions + 1; i++) {
            ...
            if (datas.size() > 0) {
                ...
                g2.setColor(Color.BLACK);
                String yLabel = ((int) ((getMinData() + (getMaxData() - getMinData()) * ((i * 1.0) / numberYDivisions)) * 100)) / 100.0 + "";
        ...
        for (int i = 0; i < datas.size(); i++) {
            if (datas.size() > 1) {
                int x0 = i * (getWidth() - padding * 2 - labelPadding) / (datas.size() - 1) + padding + labelPadding;
                int x1 = x0;
